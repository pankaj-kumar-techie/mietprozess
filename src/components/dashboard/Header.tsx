...
import { LogOut, HelpCircle, Download } from 'lucide-react';
    ...
    return (
        <header className="bg-white border-b sticky top-0 z-40 px-8 py-5 flex flex-col sm:flex-row justify-between items-center gap-4 shadow-sm">
            <div className="flex items-center gap-4">
                ...
                <h1 className="text-3xl font-black tracking-tighter text-slate-800 uppercase">{CONTENT.header.title}</h1>
            </div>
            <div className="flex flex-wrap gap-4 items-center justify-center">
                ...
                <div className="flex gap-2">
                    <Button
                        ...
                        title={CONTENT.header.export}
                    >
                        <Download className="w-5 h-5" />
                        <span className="hidden lg:inline">{CONTENT.header.export}</span>
                    </Button>
                    <Button
                    ...
                    >
                        ...
                        <span className="hidden lg:inline">{CONTENT.header.help}</span>
                    </Button>
                    <Button
                    ...
                    >
                        ...
                        <span className="hidden lg:inline">{CONTENT.header.logout}</span>
                    </Button>
                </div>
            </div>
        </header>
